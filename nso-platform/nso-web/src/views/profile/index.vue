...
const forceChangePassword = computed(() => Boolean(auth.user?.forceChangePassword));
        ...
        <div class="profile-layout">
            <section class="panel profile-identity">
                ...
                <dl class="profile-summary">
                    ...
                    <div><dt>创建时间</dt><dd>{{ formatChineseDateTime(profile?.createdAt) }}</dd></div>
                </dl>
            </section>

            <div class="profile-forms">
                <el-alert v-if="forceChangePassword" title="首次登录或管理员重置密码后，必须先修改密码才能继续使用系统。" type="warning" :closable="false" show-icon />
                <section class="panel">
                    ...
                    <div class="panel-body">
                        <el-form class="profile-form" label-position="top" @submit.prevent="saveProfile">
                            ...
                            <el-button native-type="submit" type="primary" :loading="saving" :disabled="forceChangePassword">保存资料</el-button>
                        </el-form>
                    </div>
                </section>
